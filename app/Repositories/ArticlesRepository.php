...
//            если выше не работает, то тут и в admin.blade.php
//            return session(['error' => 'Данный псевдоним уже существует']);
        }
        ...
        if($request->hasFile('image')) {
            ...
            if($image->isValid()) {
                ...
                $img->fit(Config::get('settings.articles_img')['min']['width'], Config::get('settings.articles_img')['min']['height'])->
